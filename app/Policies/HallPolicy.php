...
class HallPolicy
{
    ...
    {
        return $user->can('delete_any_hall');
    }
    ...
    {
        return $user->can('force_delete_any_hall');
    }
    ...
    {
        return $user->can('restore_any_hall');
    }

    /**
     * Determine whether the user can replicate.
     */
    public function replicate(User $user, Hall $hall): bool
    {
        return $user->can('replicate_hall');
    }
