    ...
    public function form(Schema $schema): Schema
    {
        ...
        return $schema
            ->components([
                Wizard::make([
                    // Step 1: Select Hall
                    Step::make(__('owner.availability_resource.wizard.select_hall'))
                    ...
                    // Step 2: Select Dates
                    Step::make(__('owner.availability_resource.wizard.select_dates'))
                        ->icon('heroicon-o-calendar')
                        ->schema([
                            Radio::make('date_mode')
                            ...
                            DatePicker::make('date')
                                ...
                                ->visible(fn (Get $get): bool => $get('date_mode') === 'single'),

                            // Date Range
                            Grid::make(2)
                                ->visible(fn (Get $get): bool => $get('date_mode') === 'range')
                                ->schema([
                    ...
                    Step::make(__('owner.availability_resource.wizard.select_slots'))
                    ...
                    Step::make(__('owner.availability_resource.wizard.configure'))
