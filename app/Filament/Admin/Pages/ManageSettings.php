...
class ManageSettings extends Page implements HasForms
{
    ...
    public function form(Schema $schema): Schema
    {
        return $schema
            ->components([
                \Filament\Schemas\Components\Tabs::make('settings_tabs')
                    ->tabs([
                        // ─── GENERAL ────────────────────────────────────────
                        Tab::make(__('settings.tabs.general'))
                            ->icon('heroicon-o-globe-alt')
                            ->schema([
                                Section::make(__('settings.sections.site_identity'))
                                ...
                                Section::make(__('settings.sections.regional'))
                        ...
                        // ─── CONTACT ────────────────────────────────────────
                        Tab::make(__('settings.tabs.contact'))
                            ->icon('heroicon-o-phone')
                            ->schema([
                                Section::make(__('settings.sections.email_contact'))
                                    ...
                                    ->schema([
                                        ...
                                        TextInput::make('contact.support_email')
                                ...
                                Section::make(__('settings.sections.phone_contact'))
                                ...
                                Section::make(__('settings.sections.address'))
                                    ->columns(2)
                                    ->schema([
                                        ...
                                        TextInput::make('contact.google_maps_url')
                        ...
                        // ─── SOCIAL MEDIA ───────────────────────────────────
                        Tab::make(__('settings.tabs.social'))
                            ->icon('heroicon-o-share')
                            ->schema([
                                Section::make(__('settings.sections.social_media'))
                                    ...
                                    ->schema([
                                        ...
                                        TextInput::make('social.instagram_url')
                                            ->label('Instagram')
                                            ->url()
                                            ->placeholder('https://instagram.com/majalis')
                                            ->prefixIcon('heroicon-o-globe-alt'),

                                        TextInput::make('social.twitter_url')
                                            ->label('X (Twitter)')
                                            ->url()
                                            ->placeholder('https://x.com/majalis')
                                            ->prefixIcon('heroicon-o-globe-alt'),

                                        TextInput::make('social.snapchat_url')
                                            ->label('Snapchat')
                                            ->url()
                                        ...
                                        TextInput::make('social.tiktok_url')
                                            ->label('TikTok')
                                            ->url()
                        ...
                        // ─── FINANCE ────────────────────────────────────────
                        Tab::make(__('settings.tabs.finance'))
                            ->icon('heroicon-o-banknotes')
                            ->schema([
                                Section::make(__('settings.sections.tax'))
                                    ->description(__('settings.sections.tax_desc'))
                                    ->columns(2)
                                    ->schema([
                                        TextInput::make('finance.vat_rate')
                                        ...
                                        TextInput::make('finance.currency')
                        ...
                        // ─── SEO / OPEN GRAPH ───────────────────────────────
                        Tab::make(__('settings.tabs.seo'))
                            ->icon('heroicon-o-magnifying-glass')
                            ->schema([
                                Section::make(__('settings.sections.favicon'))
                                    ->description(__('settings.sections.favicon_desc'))
                                    ->schema([
                                        FileUpload::make('seo.favicon')
                                ...
                                Section::make(__('settings.sections.open_graph'))
                                    ...
                                    ->schema([
                                        ...
                                        \Filament\Schemas\Components\Tabs::make('og_langs')
                                            ->tabs([
                                ...
                                Section::make(__('settings.sections.twitter_card'))
                                    ...
                                    ->schema([
                                        ...
                                        // per-language title & description
                                        \Filament\Schemas\Components\Tabs::make('tw_langs')
                                            ->tabs([
                                                Tab::make('English')->schema([
                                                ...
                                                Tab::make('العربية')->schema([
                                                    TextInput::make('seo.twitter_title_ar')
                                                        ->label(__('settings.fields.twitter_title') . ' (AR)')
                                                        ->placeholder('مجالس – احجز القاعة المثالية')
                                                        ->maxLength(70)
                                                        ->extraInputAttributes(['dir' => 'rtl']),

                                                    Textarea::make('seo.twitter_description_ar')
                        ...
                        // ─── GOOGLE ANALYTICS ───────────────────────────────
                        Tab::make(__('settings.tabs.gtag'))
                            ->icon('heroicon-o-chart-bar')
                            ->schema([
                                Section::make(__('settings.sections.gtag'))
                                    ->description(__('settings.sections.gtag_desc'))
                                    ->columns(2)
                                    ->schema([
                                        TextInput::make('gtag.gtag_id')
                                            ->label(__('settings.fields.gtag_id'))
                                            ->placeholder('G-XXXXXXXXXX')
                                            ->maxLength(50)
                                            ->columnSpanFull(),

                                        Toggle::make('gtag.enabled')
                                            ->label(__('settings.fields.gtag_enabled'))
                                            ->default(true),

                                        Toggle::make('gtag.anonymize_ip')
