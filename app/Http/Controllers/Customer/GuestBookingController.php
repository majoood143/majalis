...
class GuestBookingController extends Controller
{
    ...
    public function store(Request $request, Hall $hall): RedirectResponse
    {
        ...
        try {
            ...
            // ✅ FIX: Recalculate total after ServiceFeeSetting may have updated $platformFee.
            // Previously commented out, causing $totalAmount to retain stale CommissionService value.
            // Without this line: platform_fee shows correctly but total_amount excludes it.
