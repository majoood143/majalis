...
class InvoiceService___
{
    ...
    protected function sanitizeForPdf(string $text): string
    {
        ...
        // Keep Arabic, English, numbers, and basic punctuation only
        ...
        $text = preg_replace('/[\x{1F000}-\x{1F02F}]/u', '', $text); // Mahjong tiles
        $text = preg_replace('/[\x{1F0A0}-\x{1F0FF}]/u', '', $text); // Playing cards
