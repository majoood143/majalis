...
return [
    ...
    */
    ...
    'is_listed' => 'مدرجة في الموقع',
    'is_listed_help' => 'عند التعطيل، لن تظهر هذه القاعة في نتائج البحث أو صفحة القاعات',
    'listed_filter' => 'الإدراج في الموقع',
    'listed_only' => 'المدرجة فقط',
    'unlisted_only' => 'غير المدرجة فقط',
    ...
    'stats_overview' => [
        'total_revenue' => 'إجمالي الإيرادات',
        'total_revenue_desc' => 'إجمالي الإيرادات منذ البداية',
        'platform_earnings' => 'أرباح المنصة',
        'platform_earnings_desc' => 'إجمالي العمولات المحصلة',
        'monthly_revenue' => 'إيرادات الشهر',
        'monthly_revenue_desc' => 'هذا الشهر',
        'total_bookings' => 'إجمالي الحجوزات',
        'bookings_trend_up' => '+:value% مقارنة بالشهر الماضي',
        'bookings_trend_down' => ':value% مقارنة بالشهر الماضي',
        'active_halls' => 'القاعات النشطة',
        'active_halls_desc' => 'من أصل :total قاعة',
        'hall_owners' => 'أصحاب القاعات',
        'hall_owners_desc' => ':count عميل مسجل',
    ],
    ...
    'pages' => [
        ...
        'slug' => 'الرابط المختصر',
        'slug_helper' => 'معرف URL مناسب (مثال: about-us)',
        'title_en' => 'العنوان (إنجليزي)',
        'title_ar' => 'العنوان (عربي)',
        'section_main_content' => 'المحتوى الرئيسي',
        'section_main_content_desc' => 'عنوان الصفحة، الرابط، والمعلومات الأساسية',
        'section_content_en' => 'المحتوى بالإنجليزية',
        'content_en' => 'المحتوى (إنجليزي)',
        'section_content_ar' => 'المحتوى بالعربية',
        'content_ar' => 'المحتوى (عربي)',
        'section_seo' => 'إعدادات SEO',
        'section_seo_desc' => 'الوسوم الوصفية لمحركات البحث',
        'meta_title_en' => 'عنوان الميتا (إنجليزي)',
        'meta_title_ar' => 'عنوان الميتا (عربي)',
        'meta_title_helper' => 'يُنصح بـ 50-60 حرفًا',
        'meta_description_en' => 'وصف الميتا (إنجليزي)',
        'meta_description_ar' => 'وصف الميتا (عربي)',
        'meta_description_helper' => 'يُنصح بـ 150-160 حرفًا',
        'section_display_settings' => 'إعدادات العرض',
        'is_active' => 'نشط',
        'is_active_helper' => 'الصفحة مرئية للمستخدمين',
        'order' => 'الترتيب',
        'order_helper' => 'الأرقام الأصغر تظهر أولاً',
        'show_in_header' => 'عرض في الترويسة',
        'show_in_header_helper' => 'عرض الرابط في قائمة الترويسة',
        'show_in_footer' => 'عرض في التذييل',
        'show_in_footer_helper' => 'عرض الرابط في قائمة التذييل',
        'header' => 'الترويسة',
        'footer' => 'التذييل',
        'created_at' => 'تاريخ الإنشاء',
        'updated_at' => 'تاريخ التحديث',
        'filter_status' => 'الحالة',
        'filter_all' => 'جميع الصفحات',
        'filter_active' => 'النشطة فقط',
        'filter_inactive' => 'غير النشطة فقط',
    ],

    // الأسئلة الشائعة
    'faq' => 'الأسئلة الشائعة',
    'faq_items' => 'عناصر الأسئلة الشائعة',
    'faq_add_item' => 'إضافة سؤال',
    'faq_question_english' => 'السؤال (بالإنجليزية)',
    'faq_question_arabic' => 'السؤال (بالعربية)',
    'faq_answer_english' => 'الإجابة (بالإنجليزية)',
    'faq_answer_arabic' => 'الإجابة (بالعربية)',
    'faq_question_english_placeholder' => 'أدخل السؤال بالإنجليزية',
