...
return [
    ...
    */
    'fields' => [
        ...
        'event_types' => [
            ...
            'placeholder' => 'اختر نوعاً أو أكثر من أنواع المناسبات',
            'helper' => 'اختر جميع أنواع المناسبات المنطبقة على هذا الحجز',
            'helper_filtered' => 'تظهر أنواع المناسبات المقبولة من القاعة المختارة فقط',
        ],
    ...
    */
    ...
    'email' => [
        'invoice_subject' => 'فاتورة الحجز رقم #:number',
        'invoice_default_message' => 'يرجى الاطلاع على الفاتورة المرفقة لحجزك. شكراً لاختيارك لنا!',

        // =========================================================
        // REVIEW REQUEST EMAIL
        // =========================================================
        'review_request_subject' => 'كيف كانت تجربتك في :hall؟',
        'review_greeting' => 'مرحباً :name،',
        'review_intro' => 'نأمل أن تكون قد أمضيت وقتاً رائعاً في :hall يوم :date.',
        'review_message' => 'نود أن نسمع عن تجربتك! تعليقاتك تساعدنا على تحسين خدمتنا وتساعد العملاء الآخرين على اتخاذ قرارات مدروسة.',
        'review_button' => 'اترك تقييمك',
        'booking_details' => 'تفاصيل الحجز',
        'booking_number' => 'رقم الحجز',
        'hall' => 'القاعة',
        'event_date' => 'تاريخ المناسبة',
        'time_slot' => 'الفترة الزمنية',
        'review_importance' => 'تقييمك الصادق، سواء أكان إيجابياً أم بنّاءً، ذو قيمة كبيرة بالنسبة لنا. لا يستغرق سوى دقيقة ويصنع فارقاً كبيراً!',
        'review_thanks' => 'شكراً لك على اختيارك مشاركة تجربتك معنا.',
        'regards' => 'مع أطيب التحيات',
        'review_footer_note' => 'إذا كان لديك أي استفسارات حول حجزك تفضّل مناقشتها بشكل خاص، يرجى الرد على هذه الرسالة وسنكون سعداء بمساعدتك.',

        // =========================================================
        // BOOKING REMINDER EMAIL
        // =========================================================
        'reminder_subject' => 'تذكير: حجزك في :hall بعد :days أيام',
        'reminder_greeting' => 'مرحباً :name،',
        'reminder_today' => 'حجزك اليوم!',
        'reminder_tomorrow' => 'حجزك غداً!',
        'reminder_days' => 'حجزك بعد :days أيام',
        'your_booking_details' => 'تفاصيل حجزك',
        'location' => 'الموقع',
        'guests' => 'الضيوف',

        // Balance reminder
        'balance_reminder_title' => 'تذكير بالدفع',
        'balance_reminder_message' => 'لديك رصيد متبقٍ بقيمة :amount ريال عماني يجب سداده قبل موعد المناسبة.',
        'pay_balance_button' => 'سداد الرصيد الآن',

        // Preparation tips
        'preparation_tips_title' => 'نصائح للتحضير',
        'tip_arrive_early' => 'يرجى الوصول قبل 30 دقيقة من موعدك المحدد للإعداد.',
        'tip_contact_hall' => 'تواصل مع القاعة مباشرة إذا كانت لديك أي متطلبات خاصة.',
        'tip_bring_confirmation' => 'أحضر تأكيد الحجز (هذا البريد الإلكتروني) كمرجع.',

        // Closing
        'questions_contact' => 'إذا كان لديك أي استفسارات، لا تتردد في التواصل معنا.',
        'we_look_forward' => 'نتطلع إلى استضافة مناسبتك!',

        // =========================================================
        // BOOKING CONFIRMATION EMAIL
        // =========================================================
        'confirmation_subject' => 'تأكيد الحجز - :hall بتاريخ :date',
        'confirmation_greeting' => 'أخبار رائعة، :name!',
        'confirmation_intro' => 'تم تأكيد حجزك. إليك تفاصيل حجزك:',
        'confirmation_footer' => 'يرجى الاحتفاظ بهذه الرسالة لسجلاتك.',

        // =========================================================
        // BOOKING CANCELLATION EMAIL
        // =========================================================
        'cancellation_subject' => 'إلغاء الحجز - #:number',
        'cancellation_greeting' => 'مرحباً :name،',
        'cancellation_intro' => 'نأسف لإبلاغك بأن حجزك قد تم إلغاؤه.',
        'cancellation_reason' => 'سبب الإلغاء',
        'cancellation_refund' => 'مبلغ الاسترداد',
        'cancellation_refund_note' => 'إذا كان ذلك مناسباً، سيتم معالجة استرداد المبلغ خلال 5-7 أيام عمل.',

        // =========================================================
        // GENERAL
        // =========================================================
        'view_booking_button' => 'عرض الحجز',
        'contact_support' => 'تواصل مع الدعم',
        'footer_address' => 'مسقط، عُمان',
        'unsubscribe_note' => 'أنت تتلقى هذا البريد الإلكتروني لأن لديك حجزاً لدينا.',
