...
return [
    ...
    */
    ...
    'stats_overview' => [
        'total_revenue' => 'Total Revenue',
        'total_revenue_desc' => 'All-time revenue',
        'platform_earnings' => 'Platform Earnings',
        'platform_earnings_desc' => 'Total commission earned',
        'monthly_revenue' => 'Monthly Revenue',
        'monthly_revenue_desc' => 'This month',
        'total_bookings' => 'Total Bookings',
        'bookings_trend_up' => '+:value% from last month',
        'bookings_trend_down' => ':value% from last month',
        'active_halls' => 'Active Halls',
        'active_halls_desc' => 'Out of :total total halls',
        'hall_owners' => 'Hall Owners',
        'hall_owners_desc' => ':count customers registered',
    ],
    ...
    'pages' => [
        ...
        'slug' => 'Slug',
        'slug_helper' => 'URL-friendly identifier (e.g., about-us)',
        'title_en' => 'Title (English)',
        'title_ar' => 'Title (Arabic)',
        'section_main_content' => 'Main Content',
        'section_main_content_desc' => 'Page title, slug, and basic information',
        'section_content_en' => 'English Content',
        'content_en' => 'Content (English)',
        'section_content_ar' => 'Arabic Content',
        'content_ar' => 'Content (Arabic)',
        'section_seo' => 'SEO Settings',
        'section_seo_desc' => 'Meta tags for search engines',
        ...
        'is_active' => 'Active',
        'is_active_helper' => 'Page is visible to users',
        'order' => 'Display Order',
        'order_helper' => 'Lower numbers appear first',
        'show_in_header' => 'Show in Header',
        'show_in_header_helper' => 'Display link in header navigation',
        'show_in_footer' => 'Show in Footer',
        'show_in_footer_helper' => 'Display link in footer navigation',
        'header' => 'Header',
        'footer' => 'Footer',
        'created_at' => 'Created At',
    ...
    'faq' => 'FAQ',
    'faq_items' => 'FAQ Items',
    'faq_add_item' => 'Add FAQ Item',
    'faq_question_english' => 'Question (English)',
    'faq_question_arabic' => 'Question (Arabic)',
    'faq_answer_english' => 'Answer (English)',
    'faq_answer_arabic' => 'Answer (Arabic)',
    'faq_question_english_placeholder' => 'Enter the question in English',
