<x-filament-panels::page>
        ...
        @if ($reportData['type'] === 'monthly')
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-3 lg:grid-cols-6">
                    {{-- Total Bookings --}}
                    <div
                        class="p-4 bg-white border border-gray-200 shadow-sm dark:bg-gray-800 rounded-xl dark:border-gray-700">
                    ...
                    {{-- Net Earnings --}}
                    <div
                        class="p-4 border border-green-200 shadow-sm bg-green-50 dark:bg-green-900/20 rounded-xl dark:border-green-700">
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                    {{-- Daily Revenue Chart --}}
                    <div
                        class="p-6 bg-white border border-gray-200 shadow-sm dark:bg-gray-800 rounded-xl dark:border-gray-700">
    ...
    data-values="{{ json_encode(array_column($reportData['daily_data'] ?? [], 'net_earnings')) }}">
                                    ...
                                    <div
                                        ...
                                        <div>
                                            ...
                                            <div class="text-sm text-gray-500 dark:text-gray-400">
                                                {{ $hall['bookings_count'] }} {{ __('owner.reports.bookings') }}
                                            </div>
                                        </div>
                ...
                <div
                    ...
                    <div class="grid grid-cols-2 gap-4 md:grid-cols-4">
                        @php
                            // Convert indexed array to keyed array by slot name
                            $slotData = collect($reportData['slot_breakdown'] ?? [])->keyBy('slot');
                        @endphp
        ...
        @elseif($reportData['type'] === 'yearly')
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div
                        class="p-4 border border-blue-200 shadow-sm bg-blue-50 dark:bg-blue-900/20 rounded-xl dark:border-blue-700">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            <thead class="bg-gray-50 dark:bg-gray-700">
                                <tr>
                                    <th
                                        class="px-4 py-3 text-sm font-medium text-left text-gray-500 dark:text-gray-400">
                                        {{ __('owner.reports.month') }}
                                    </th>
                                    <th
                                        class="px-4 py-3 text-sm font-medium text-center text-gray-500 dark:text-gray-400">
                                        {{ __('owner.reports.bookings') }}
                                    </th>
                                    <th
                                        class="px-4 py-3 text-sm font-medium text-right text-gray-500 dark:text-gray-400">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                @foreach ($reportData['monthly_data'] as $month)
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                        ...
                                        <td
                                            class="px-4 py-3 text-sm font-medium text-right text-green-600 dark:text-green-400">
                    ...
                    <div
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                            <div class="p-4 rounded-lg bg-green-50 dark:bg-green-900/20">
                                ...
                                <div class="text-sm text-green-600 dark:text-green-400">
                                    {{ $reportData['payout_summary']['payout_count'] }}
                                    {{ __('owner.reports.payouts') }}
                                </div>
                            </div>
                            ...
                            <div class="p-4 rounded-lg bg-blue-50 dark:bg-blue-900/20">
                                ...
                                <div class="text-xl font-bold text-blue-700 dark:text-blue-300">
                                    {{ number_format($reportData['summary']['net_earnings'] - $reportData['payout_summary']['total_received'] - $reportData['payout_summary']['pending'], 3) }}
                                    OMR
                                </div>
                            </div>
                        </div>
        ...
        @elseif($reportData['type'] === 'comparison')
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                    ...
                    <div
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center justify-between">
                                <span
                                    class="text-gray-500 dark:text-gray-400">{{ __('owner.reports.bookings') }}</span>
                                <span
                                    class="font-bold text-gray-900 dark:text-white">{{ $reportData['current']['bookings'] }}</span>
                            </div>
                            <div class="flex items-center justify-between">
                                <span class="text-gray-500 dark:text-gray-400">{{ __('owner.reports.gross') }}</span>
                                <span
                                    class="font-bold text-gray-900 dark:text-white">{{ number_format($reportData['current']['gross'], 3) }}
                                    OMR</span>
                            </div>
                            <div class="flex items-center justify-between">
                                <span
                                    class="text-gray-500 dark:text-gray-400">{{ __('owner.reports.commission') }}</span>
                                <span
                                    class="font-bold text-red-600 dark:text-red-400">-{{ number_format($reportData['current']['commission'], 3) }}
                                    OMR</span>
                            </div>
                            <div
                                class="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-gray-700">
                                <span
                                    class="font-medium text-gray-900 dark:text-white">{{ __('owner.reports.net') }}</span>
                                <span
                                    class="text-xl font-bold text-green-600 dark:text-green-400">{{ number_format($reportData['current']['net'], 3) }}
                                    OMR</span>
                            </div>
                        </div>
                    </div>
                    ...
                    {{-- Previous Month --}}
                    <div
                        class="p-6 border border-gray-200 shadow-sm bg-gray-50 dark:bg-gray-700/50 rounded-xl dark:border-gray-600">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center justify-between">
                                <span
                                    class="text-gray-500 dark:text-gray-400">{{ __('owner.reports.bookings') }}</span>
                                <span
                                    class="font-bold text-gray-700 dark:text-gray-300">{{ $reportData['previous']['bookings'] }}</span>
                            </div>
                            <div class="flex items-center justify-between">
                                <span class="text-gray-500 dark:text-gray-400">{{ __('owner.reports.gross') }}</span>
                                <span
                                    class="font-bold text-gray-700 dark:text-gray-300">{{ number_format($reportData['previous']['gross'], 3) }}
                                    OMR</span>
                            </div>
                            <div class="flex items-center justify-between">
                                <span
                                    class="text-gray-500 dark:text-gray-400">{{ __('owner.reports.commission') }}</span>
                                <span
                                    class="font-bold text-red-500 dark:text-red-400">-{{ number_format($reportData['previous']['commission'], 3) }}
                                    OMR</span>
                            </div>
                            <div
                                class="flex items-center justify-between pt-4 border-t border-gray-300 dark:border-gray-600">
                                <span
                                    class="font-medium text-gray-700 dark:text-gray-300">{{ __('owner.reports.net') }}</span>
                                <span
                                    class="text-xl font-bold text-gray-700 dark:text-gray-300">{{ number_format($reportData['previous']['net'], 3) }}
                                    OMR</span>
                            </div>
                        </div>
                    </div>
                ...
                <div
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                        ...
                        <div class="text-center">
                            <div
                                class="text-3xl font-bold {{ $reportData['changes']['bookings'] >= 0 ? 'text-green-600' : 'text-red-600' }}">
                        ...
                        <div class="text-center">
                            <div
                                class="text-3xl font-bold {{ $reportData['changes']['gross'] >= 0 ? 'text-green-600' : 'text-red-600' }}">
                        ...
                        <div class="text-center">
                            <div
                                class="text-3xl font-bold {{ $reportData['changes']['net'] >= 0 ? 'text-green-600' : 'text-red-600' }}">
                ...
                @foreach ($reportData['hall_performance'] as $hall)
                    <div
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-6 md:grid-cols-4">
                            <div>
                                <div class="text-sm text-gray-500 dark:text-gray-400">
                                    {{ __('owner.reports.bookings') }}</div>
                                <div class="text-lg font-semibold text-gray-900 dark:text-white">
                                    {{ $hall['bookings_count'] }}</div>
                            </div>
                            <div>
                                <div class="text-sm text-gray-500 dark:text-gray-400">{{ __('owner.reports.gross') }}
                                </div>
                                <div class="text-lg font-semibold text-gray-900 dark:text-white">
                                    {{ number_format($hall['gross_revenue'], 3) }} OMR</div>
                            </div>
                            <div>
                                <div class="text-sm text-gray-500 dark:text-gray-400">
                                    {{ __('owner.reports.commission') }}</div>
                                <div class="text-lg font-semibold text-red-600 dark:text-red-400">
                                    -{{ number_format($hall['commission'], 3) }} OMR</div>
                            </div>
                            <div>
                                <div class="text-sm text-gray-500 dark:text-gray-400">
                                    {{ __('owner.reports.avg_booking') }}</div>
                                <div class="text-lg font-semibold text-blue-600 dark:text-blue-400">
                                    {{ number_format($hall['avg_booking'], 3) }} OMR</div>
                            </div>
                        </div>

                        {{-- Monthly Trend --}}
                        <div class="h-32">
                            <canvas id="hallChart{{ $hall['hall_id'] }}" wire:ignore
    ...
    @else
        {{-- No Data State --}}
        <div
            class="p-12 text-center bg-white border border-gray-200 shadow-sm dark:bg-gray-800 rounded-xl dark:border-gray-700">
            <x-heroicon-o-chart-bar class="w-16 h-16 mx-auto mb-4 text-gray-400 dark:text-gray-500" />
...
@push('scripts')
    ...
    <script>
        ...
        /**
         * Initialize all charts based on current report type
         */
        function initializeCharts() {
            ...
            setTimeout(() => {
                ...
                initializeHallCharts();
            }, 50);
        }

        /**
         * Initialize Daily Revenue Chart (Monthly Report)
         */
        function initializeDailyChart() {
            ...
            @if (!empty($reportData) && ($reportData['type'] ?? '') === 'monthly' && isset($reportData['daily_data']))
                const dailyData = @json(array_values($reportData['daily_data']));

                if (!dailyData || dailyData.length === 0) return;

                const dailyLabels = dailyData.map(day => day.date);
                const dailyNetValues = dailyData.map(day => day.net || day.net_earnings || 0);
    ...
    window.chartInstances.monthlyRevenueChart = new Chart(monthlyCtx, {
         ...
         */
        function initializeHallCharts() {
            document.querySelectorAll('[id^="hallChart"]').forEach(function(canvas) {
                if (window.chartInstances[canvas.id]) return; // Already initialized
        ...
        // Handle Livewire 3 events - reinitialize charts after component updates
        document.addEventListener('livewire:init', function() {
            // Listen for the custom report-updated event
        ...
        // Also handle Livewire morph for additional safety
