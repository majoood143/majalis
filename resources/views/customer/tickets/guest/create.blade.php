...
@section('title', __('tickets_guest.create_title') . ' - Majalis')
...
<div class="px-4 py-8 mx-auto max-w-3xl sm:px-6 lg:px-8">
    ...
    {{-- Header --}}
    <div class="mb-6">
        <h1 class="mb-1 text-2xl font-bold text-gray-900">{{ __('tickets_guest.create_title') }}</h1>
        <p class="text-gray-600 text-sm">{{ __('tickets_guest.create_subtitle') }}</p>
    </div>
    ...
    <form action="{{ route('guest.tickets.store') }}" method="POST" enctype="multipart/form-data"
