                    ...
                    <div class="p-5 border-b border-gray-100">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center gap-3 p-2.5 rounded-xl bg-gray-50">
                                ...
                                <a href="{{ $instagramUrl }}" target="_blank" rel="noopener noreferrer" class="flex-1 min-w-0 text-sm font-medium text-gray-700 truncate transition hover:text-pink-600">mm {{ $instagramDisplay }}</a>
