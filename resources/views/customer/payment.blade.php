            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                ...
                <div class="space-y-6 lg:col-span-2">
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="p-4 bg-white border border-blue-200 rounded-lg">
                                        <div class="space-y-3">
                                            <!-- Amount to Pay NOW -->
                                            <div
                                                class="flex items-center justify-between pb-3 border-b border-blue-200">
                                                <span class="font-semibold text-gray-700">
                                                    {{ __('halls.pay_now_advance') }}
                                                </span>
                                                <span class="text-2xl font-bold text-blue-600">
                                                    {{ number_format($booking->advance_amount, 3) }} <img
                                            ...
                                            <div class="flex items-center justify-between">
                                                ...
                                                <span class="text-lg font-semibold text-gray-800">
                                                    {{ number_format($booking->balance_due, 3) }} <img
                                                        src="{{ asset('images/Medium.svg') }}" alt="Omani Riyal"
                                                        class="inline w-5 h-5 -mt-1">
                                                </span>
                                            </div>
                                            ...
                                            <div
                                                ...
                                                <span class="text-lg font-semibold text-gray-900">
                                                    {{ number_format($booking->total_amount, 3) }} <img
                                                        src="{{ asset('images/Medium.svg') }}" alt="Omani Riyal"
                                                        class="inline w-5 h-5 -mt-1">
                                                </span>
                                            </div>
                                    ...
                                    <div
                                        ...
                                        <svg class="w-5 h-5 flex-shrink-0 mt-0.5 text-amber-600" fill="currentColor"
                                            viewBox="0 0 20 20">
                    ...
                    <div class="p-6 bg-white border border-gray-200 shadow-sm rounded-2xl md:p-8">
                        ...
                        <form action="{{ route('customer.booking.process-payment', ['booking' => $booking->id]) }}"
                            ...
                            <div class="space-y-4">
                                ...
                                <label class="block cursor-pointer payment-option">
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-start gap-4">
                                            <div
                                                class="flex items-center justify-center flex-shrink-0 w-12 h-12 rounded-lg bg-gradient-to-br from-green-500 to-emerald-600">
                                            ...
                                            <div class="flex-1">
                                                <div class="mb-1 font-bold text-gray-900">
                                                    {{ __('halls.online_payment') }}</div>
                                                <div class="mb-3 text-sm text-gray-600">
                                                    {{ __('halls.pay_with_card_wallet') }}</div>
                                                <div class="flex flex-wrap gap-2">
                                                    <span
                                                        class="px-3 py-1 text-xs font-medium text-gray-700 bg-white border border-gray-200 rounded-lg">💳
                                                        {{ __('halls.credit_card') }}</span>
                                                    <span
                                                        class="px-3 py-1 text-xs font-medium text-gray-700 bg-white border border-gray-200 rounded-lg">🏦
                                                        {{ __('halls.debit_card') }}</span>
                                                    <span
                                                        class="px-3 py-1 text-xs font-medium text-gray-700 bg-white border border-gray-200 rounded-lg">📱
                                                        {{ __('halls.digital_wallet') }}</span>
                                                </div>
                                            </div>
                                            {{-- <div class="flex-shrink-0">
                                ...
                                <label class="block cursor-pointer payment-option">
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-start gap-4">
                                            <div
                                                class="flex items-center justify-center flex-shrink-0 w-12 h-12 rounded-lg bg-gradient-to-br from-blue-500 to-indigo-600">
                                                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2"
                                            ...
                                            <div class="flex-1">
                                                <div class="mb-1 font-bold text-gray-900">
                                                    {{ __('halls.bank_transfer') }}</div>
                                                <div class="text-sm text-gray-600">
                                                    {{ __('halls.bank_transfer_desc') }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </label>
                                ...
                                <label class="block cursor-pointer payment-option">
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-start gap-4">
                                            <div
                                                class="flex items-center justify-center flex-shrink-0 w-12 h-12 rounded-lg bg-gradient-to-br from-amber-500 to-orange-600">
                                                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2"
                                            ...
                                            <div class="flex-1">
                                                <div class="mb-1 font-bold text-gray-900">
                                                    {{ __('halls.cash_payment') }}</div>
                                                <div class="text-sm text-gray-600">{{ __('halls.pay_at_venue') }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <!-- Security Notice -->
                            <div
                                class="flex items-start gap-3 p-4 mt-6 border border-green-200 bg-green-50 rounded-xl">
                    ...
                    <div class="sticky p-6 bg-white border border-gray-200 shadow-lg top-24 rounded-2xl">
                        ...
                        <div class="py-4 space-y-3 border-t border-gray-200">
                            <div class="flex items-center gap-2 text-sm">
                                ...
                                <span
                                    class="text-gray-600">{{ \Carbon\Carbon::parse($booking->booking_date)->format('d M Y') }}</span>
                            </div>
                            <div class="flex items-center gap-2 text-sm">
                                <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                            ...
                            <div class="flex items-center gap-2 text-sm">
                                ...
                                <span class="text-gray-600">{{ $booking->number_of_guests }}
                                    {{ __('halls.guests_count') }}</span>
                            </div>
                        </div>
                        ...
                        <div class="py-4 space-y-3 border-t border-gray-200">
                            <div class="flex justify-between text-sm">
                                ...
                                <span class="font-medium text-gray-900">{{ number_format($booking->hall_price, 3) }}
                            ...
                            @if ($booking->services_price > 0)
                                <div class="flex justify-between text-sm">
                                    ...
                                    <span
                                        class="font-medium text-gray-900">{{ number_format($booking->services_price, 3) }}
                                        <img src="{{ asset('images/Medium.svg') }}" alt="Omani Riyal"
                                            class="inline w-5 h-5 -mt-1"></span>
                                </div>
                            @endif
                            ...
                            @if ($booking->platform_fee > 0)
                                <div class="flex justify-between text-sm">
                                    ...
                                    <span
                                        class="font-medium text-gray-900">{{ number_format($booking->platform_fee, 3) }}
                                        <img src="{{ asset('images/Medium.svg') }}" alt="Omani Riyal"
                                            class="inline w-5 h-5 -mt-1"></span>
                                </div>
                            @endif
