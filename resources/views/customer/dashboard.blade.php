    ...
    <div class="grid grid-cols-1 gap-6 mb-8 md:grid-cols-2 lg:grid-cols-4">
        <div class="p-6 bg-white rounded-lg shadow-md">
            <div class="flex items-center justify-between">
                <div>
                    <p class="mb-1 text-sm text-gray-600">{{ __('dashboard.total_bookings') }}</p>
        ...
        <div class="p-6 bg-white rounded-lg shadow-md">
            <div class="flex items-center justify-between">
                <div>
                    <p class="mb-1 text-sm text-gray-600">{{ __('dashboard.completed') }}</p>
        ...
        <div class="p-6 bg-white rounded-lg shadow-md">
            <div class="flex items-center justify-between">
                <div>
                    <p class="mb-1 text-sm text-gray-600">{{ __('dashboard.cancelled') }}</p>
    ...
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-lg shadow-md">
                <div class="p-6 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        <h2 class="text-xl font-semibold">{{ __('dashboard.upcoming_bookings') }}</h2>
                ...
                <div class="divide-y divide-gray-200">
                    ...
                    @forelse($upcomingBookings as $booking)
                        <div class="p-6 transition hover:bg-gray-50">
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    <h3 class="mb-1 font-semibold text-gray-900">{{ $booking->hall->name ?? __('dashboard.unnamed_hall') }}</h3>
                    ...
                    @empty
                        <div class="p-12 text-center">
                            ...
                            <p class="mb-4 text-gray-600">{{ __('dashboard.no_upcoming_bookings') }}</p>
        ...
        <div class="lg:col-span-1">
            <div class="p-6 mb-6 bg-white rounded-lg shadow-md">
                <h3 class="mb-4 text-lg font-semibold">{{ __('dashboard.quick_actions') }}</h3>
                <div class="space-y-3">
                    <a href="{{ route('customer.halls.index') }}"
                        ...
                        <span class="font-medium text-gray-900 group-hover:text-indigo-600">{{ __('dashboard.browse_halls') }}</span>
                    </a>
                    ...
                    <a href="{{ route('customer.bookings') }}"
                        ...
                        <span class="font-medium text-gray-900 group-hover:text-gray-600">{{ __('dashboard.my_bookings') }}</span>
                    </a>
                    ...
                    <a href="{{ route('customer.profile') }}"
                        ...
                        <span class="font-medium text-gray-900 group-hover:text-gray-600">{{ __('dashboard.my_profile') }}</span>
                    </a>
                </div>
            </div>
            ...
            <!-- Account Info -->
            <div class="p-6 bg-white rounded-lg shadow-md">
                <h3 class="mb-4 text-lg font-semibold">{{ __('dashboard.account_info') }}</h3>
                <div class="space-y-3 text-sm">
                    <div>
                        <span class="text-gray-600">{{ __('dashboard.member_since') }}</span>
                        <div class="font-medium">{{ Auth::user()->created_at->format(__('dashboard.member_since_format')) }}</div>
                    </div>
                    <div>
                        <span class="text-gray-600">{{ __('dashboard.email') }}</span>
                        <div class="font-medium">{{ Auth::user()->email }}</div>
                    </div>
                    <div>
                        <span class="text-gray-600">{{ __('dashboard.phone') }}</span>
                        <div class="font-medium">{{ Auth::user()->phone ?? __('dashboard.not_set') }}</div>
                    </div>
                </div>
            </div>
        </div>
