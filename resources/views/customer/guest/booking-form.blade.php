                    ...
                    <div class="p-6">
                        ...
                        <div class="p-4 mb-6 border border-blue-200 rounded-lg bg-blue-50">
                            ...
                            <div class="space-y-1 text-sm text-blue-800">
                                <p><span class="font-medium">{{ __('guest.details_label_guest_name') }}:</span> {{ $guestSession->name }}</p>
                                <p><span class="font-medium">{{ __('guest.details_label_guest_email') }}:</span> {{ $guestSession->email }}</p>
                                <p><span class="font-medium">{{ __('guest.details_label_guest_phone') }}:</span> {{ $guestSession->phone }}</p>
                            </div>
                        </div>
                        ...
                        >
                                ...
                                <div class="grid grid-cols-2 gap-3 sm:grid-cols-4">
                                    @php
                                        $timeSlots = [
                                            ...
                                            'afternoon' => ['label' => __('guest.time_slot_afternoon'), 'icon' => '☀️'],
                                            'evening' => ['label' => __('guest.time_slot_evening'), 'icon' => '🌙'],
                                            'full_day' => ['label' => __('guest.time_slot_full_day'), 'icon' => '📅'],
                                        ];
                                    @endphp
                            ...
                            <div class="mb-5">
                                ...
                                <p class="mt-1 text-xs text-gray-500">
                                    {{ __('guest.form_capacity') }}: {{ $hall->capacity_min }} - {{ $hall->capacity_max }} {{ __('guest.form_guests_label') }}
                                </p>
                            ...
                            <div class="mb-5">
                                ...
                                >
                                    ...
                                    <option value="wedding" {{ old('event_type') === 'wedding' ? 'selected' : '' }}>{{ __('guest.event_type_wedding') }}</option>
                                    <option value="corporate" {{ old('event_type') === 'corporate' ? 'selected' : '' }}>{{ __('guest.event_type_corporate') }}</option>
                                    <option value="birthday" {{ old('event_type') === 'birthday' ? 'selected' : '' }}>{{ __('guest.event_type_birthday') }}</option>
                                    <option value="conference" {{ old('event_type') === 'conference' ? 'selected' : '' }}>{{ __('guest.event_type_conference') }}</option>
                                    <option value="graduation" {{ old('event_type') === 'graduation' ? 'selected' : '' }}>{{ __('guest.event_type_graduation') }}</option>
                                    <option value="other" {{ old('event_type') === 'other' ? 'selected' : '' }}>{{ __('guest.event_type_other') }}</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-5">
                                ...
                                <textarea
                                    ...
                                    rows="3"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                                    placeholder="{{ __('guest.form_special_requests_placeholder') }}"
                            ...
                            <div class="mb-6">
                                <label class="flex items-start">
                                    ...
                                    <span class="text-sm text-gray-600 ms-2">
                                        ...
                                        <a href="#" class="text-primary-600 hover:underline" target="_blank">{{ __('guest.form_terms_conditions') }}</a>
                                        {{ __('guest.form_and') }}
                                        <a href="#" class="text-primary-600 hover:underline" target="_blank">{{ __('guest.form_cancellation_policy') }}</a>
                                    </span>
                                </label>
                                @error('agree_terms')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
