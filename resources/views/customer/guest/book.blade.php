    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-center space-x-4 rtl:space-x-reverse">
                ...
                <div class="flex items-center">
                    ...
                    <span class="ms-2 text-sm font-medium text-primary-600">{{ __('guest.step_1_guest_info') }}</span>
                </div>
                ...
                {{-- Step 2: Verify --}}
                <div class="flex items-center">
                    <span class="flex items-center justify-center w-8 h-8 rounded-full bg-gray-300 text-gray-600 text-sm font-medium">
                        2
                    </span>
                    <span class="ms-2 text-sm font-medium text-gray-500">{{ __('guest.step_2_verify') }}</span>
                </div>
                ...
                <div class="flex items-center">
                    ...
                    <span class="ms-2 text-sm font-medium text-gray-500">{{ __('guest.step_3_booking') }}</span>
                </div>
            </div>
        </div>

        {{-- Hall Info Card --}}
        <div class="bg-white rounded-lg shadow-sm p-4 mb-6 flex items-center space-x-4 rtl:space-x-reverse">
            ...
            <div class="flex-1">
                ...
                <p class="text-sm font-medium text-primary-600">{{ number_format($hall->price_per_slot, 3) }} {{ __('OMR') }}</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                ...
                <p class="text-sm text-gray-500 mt-1">{{ __('guest.guest_booking_note') }}</p>
            </div>
            ...
            <div class="p-6">
                        ...
                        @if(session('show_login_modal'))
                            <div class="mt-4 flex flex-col sm:flex-row gap-3">
                                <a 
                                    ...
                                    class="inline-flex justify-center items-center px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition"
                                >
                                ...
                                <button 
                                    ...
                                    class="inline-flex justify-center items-center px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition"
                                >
                ...
                >
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex">
                            <span class="inline-flex items-center px-3 py-3 border border-e-0 border-gray-300 bg-gray-50 text-gray-500 text-sm rounded-s-lg">
                                +968
                            </span>
                            <input 
                                type="tel" 
                ...
                <div class="mt-6 pt-6 border-t border-gray-200">
                    <p class="text-sm text-center text-gray-600 mb-4">{{ __('Or') }}</p>
                    <div class="flex flex-col sm:flex-row gap-3">
                        <a 
                            href="{{ route('login', ['redirect' => route('customer.book', $hall->slug)]) }}"
                            class="flex-1 inline-flex justify-center items-center px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition"
                        >
