...
<head>
    ...
    <title>{{ app()->getLocale() === 'ar' ? '500 - خطأ في الخادم' : '500 - Server Error' }} | {{ config('app.name', 'Majalis') }}</title>
    ...
    <main class="flex-1 flex items-center justify-center px-4 py-16">
        <div class="text-center max-w-lg w-full">
            ...
            <div class="float-anim mb-4 flex justify-center">
                <div class="w-24 h-24 rounded-full flex items-center justify-center shake-anim" style="background-color:#E8D5C4;">
            ...
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-800 mb-3">
                {{ app()->getLocale() === 'ar' ? 'خطأ في الخادم' : 'Internal Server Error' }}
            </h1>

            <p class="text-gray-500 text-base sm:text-lg mb-10 leading-relaxed">
                {{ app()->getLocale() === 'ar'
                    ? 'حدث خطأ غير متوقع من جهتنا. فريقنا على علم بالمشكلة وسيتم حلها في أقرب وقت ممكن.'
