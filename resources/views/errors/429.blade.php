...
<head>
    ...
    <title>{{ app()->getLocale() === 'ar' ? '429 - طلبات كثيرة' : '429 - Too Many Requests' }} | {{ config('app.name', 'Majalis') }}</title>
        ...
        <div class="text-center max-w-lg w-full">
            ...
            <div class="float-anim mb-4 flex justify-center">
                <div class="relative w-24 h-24">
                    <div class="pulse-ring absolute inset-0 rounded-full opacity-30" style="background-color:#B9916D;"></div>
                    <div class="relative w-24 h-24 rounded-full flex items-center justify-center" style="background-color:#E8D5C4;">
            ...
            <p class="text-gray-500 text-base sm:text-lg mb-10 leading-relaxed">
                {{ app()->getLocale() === 'ar'
                    ? 'لقد تجاوزت الحد المسموح به من الطلبات. يرجى الانتظار لحظة ثم المحاولة مرة أخرى.'
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-3">
                <button onclick="location.reload()"
                    ...
                    {{ app()->getLocale() === 'ar' ? 'حاول مرة أخرى' : 'Try Again' }}
                </button>
                <a href="{{ url('/') }}"
