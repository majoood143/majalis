...
@section('header-subtitle')
    {{ __('hall-owner.hall.created.email.owner_header_subtitle') }}
@endsection

@section('content')
    {{-- Icon --}}
    <div style="text-align: center; margin-bottom: 24px;">
        <div style="width: 80px; height: 80px; background: linear-gradient(135deg, #059669 0%, #10b981 100%); border-radius: 50%; display: inline-flex; align-items: center; justify-content: center; box-shadow: 0 8px 24px rgba(5, 150, 105, 0.3);">
    ...
    <h2 style="text-align: center; color: #1f2937; font-size: 22px; font-weight: 700; margin: 0 0 8px 0;">
        {{ __('hall-owner.hall.created.email.owner_title') }}
    </h2>
    <p style="text-align: center; color: #6b7280; margin: 0 0 24px 0;">
        {!! __('hall-owner.hall.created.email.owner_greeting', ['name' => $owner->name]) !!}
    </p>

    {{-- Intro --}}
    <p style="color: #374151; font-size: 15px; line-height: 1.7; margin: 0 0 24px 0;">
        {!! __('hall-owner.hall.created.email.owner_intro', ['hall' => $hallName]) !!}
    </p>
    ...
    <div style="text-align: center; margin: 28px 0;">
        <a href="{{ $publicUrl }}"
           style="display: inline-block; padding: 13px 28px; background: linear-gradient(135deg, #059669 0%, #10b981 100%); color: white; text-decoration: none; border-radius: 8px; font-size: 14px; font-weight: 600; box-shadow: 0 4px 12px rgba(5, 150, 105, 0.4);">
            {{ __('hall-owner.hall.created.email.owner_view_button') }}
        </a>
    </div>

    <div style="border-top: 1px solid #e5e7eb; padding-top: 16px; margin-top: 8px;">
        <p style="color: #9ca3af; font-size: 12px; text-align: center; margin: 0;">
            {{ __('hall-owner.hall.created.email.owner_footer_note') }}
        </p>
    </div>
